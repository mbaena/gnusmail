...
public class RuleSpanish {
 /**
    ...
    /**
     * Constructor de la clase RuleSpanish
     */
    public RuleSpanish(int idRegla, String oldCad, String newCad, int oldOff, int newOff, int raizMin, String condicion)
    {
        id=idRegla;
        old_end=oldCad;
        new_end=newCad;
