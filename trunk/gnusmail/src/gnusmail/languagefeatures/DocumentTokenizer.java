...
/**
 * This class tokenizes a document, taking into account different separator symbols
 * @author jmcarmona
 */
public class DocumentTokenizer {
	...
	public DocumentTokenizer(String emailBody) {
		this.body = emailBody.toLowerCase();
		tokens = new LinkedList<Token>();
	}

	public DocumentTokenizer(String emailBody, Language lang) {
		this.body = emailBody;
		tokens = new LinkedList<Token>();
		this.lang = lang;
	}
